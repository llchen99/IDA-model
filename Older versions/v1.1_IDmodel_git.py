...
print(df_scores)
print(f'accuracy RF {np.round(accuracy_RF_sign, decimals= 2)}')
print(f'sens RF {np.round(sens_RF_sign, decimals= 2)}')
print(f'spec RF {np.round(spec_RF_sign, decimals =2)}')
print(f'aucs_RF {np.round(aucs_RF_sign, decimals=2)}')

print(f'accuracy SVM {np.round(accuracy_SVM_sign, decimals=2)}')
print(f'sens SVM {np.round(sens_SVM_sign, decimals=2)}')
print(f'spec SVM {np.round(spec_SVM_sign, decimals=2)}')
print(f'aucs SVM {np.round(aucs_SVM_sign, decimals=2)}')