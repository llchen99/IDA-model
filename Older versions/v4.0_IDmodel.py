...
big_cv_10fold = model_selection.StratifiedKFold(n_splits=10, shuffle=True, random_state=22) 
...
continuous_keys2 = [x for x in continuous_keys if x != 'BMI'] # as BMI does not exist in df_1_baseline and df_control

for key in dict_features:
    if key == 'BMI': # as BMI does not exist in df_1_baseline and df_control
