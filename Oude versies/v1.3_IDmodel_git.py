...
# LOG OF CHANGES
# - Veranderd in een jupyter notebook om makkelijk losse stukjes code te kunnen runnen
# - Doorgegaan met testdata valideren
# - Testjes met stratificeren
# - Aan de baseline functie toegevoegd dat er leuke plotjes bij komen
